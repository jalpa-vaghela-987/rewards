...
class RejectedGiftCard extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(Redemption $r)
    {
        ...
        $this->rejection_reason = $this->redemption->rejection_reason;
        ...
        if ($this->reward->use_set_amount && $this->reward->is_custom) {
            $this->tagline = $this->reward->title.' redemption  rejected.';
        }
    }
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage())
            ...
            //            ->greeting('Oops!')
            ->line($this->tagline)
            ->line('Rejection Reason: '.$this->rejection_reason ?? ' ');
    }

...
function esotera_enqueue_styles() {
	...
	wp_enqueue_style( 'esotera-themefonts', get_template_directory_uri() . '/resources/fonts/fontfaces.css', null, _CRYOUT_THEME_VERSION ); // fontfaces.css
	...
	wp_add_inline_style( 'esotera-main', preg_replace( "/[\n\r\t\s]+/", " ", esotera_custom_styles() ) ); // includes/custom-styles.php

} // esotera_enqueue_styles
...
} //esotera_responsive_meta()
add_action( 'cryout_meta_hook', 'esotera_responsive_meta' );

/*
 * esotera_editor_styles() is located in custom-styles.php
 */

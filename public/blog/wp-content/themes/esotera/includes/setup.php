 ...
 */
add_action( 'after_setup_theme', 'esotera_content_width' ); // mostly for dashboard
add_action( 'template_redirect', 'esotera_content_width' );

/** Tell WordPress to run esotera_setup() when the 'after_setup_theme' hook is run. */
...
function esotera_main_menu() { ?>
	...
	wp_nav_menu( array(
		...
		'fallback_cb' 	=> 'esotera_default_menu'

...
<!--				</div>-->
			...
			$esotera_excerpt_mode = 'excerpt'; // default
			if ( $esoteras['theme_excerptarchive'] == "full" ) { $esotera_excerpt_mode = 'content'; }
			if ( is_sticky() && $esoteras['theme_excerptsticky'] == "full" ) { $esotera_excerpt_mode = 'content'; }
			if ( $esoteras['theme_excerpthome'] == "full" && ! is_archive() && ! is_search() ) { $esotera_excerpt_mode = 'content'; }
			if ( false != get_post_format() ) { $esotera_excerpt_mode = 'content'; }

			switch ( $esotera_excerpt_mode ) {
				case 'content': ?>

...
( function( $, api ) {
	...
	api.controlConstructor['bizbell-repeater-text'] = api.Control.extend({
	    ...
	    // upsell 
    api.sectionConstructor['bizbell-upsell'] = api.Section.extend( {
...
*/
 jQuery(document).ready(function($) {
    // $('#bizbell-img-container li label img').click(function(){    	
    //     $('#bizbell-img-container li').each(function(){
    //         $(this).find('img').removeClass ('bizbell-radio-img-selected') ;
    //     });
    //     $(this).addClass ('bizbell-radio-img-selected') ;
    // }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', bizbell_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', bizbell_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', bizbell_customize_multi_remove_field )
    ...
    $('#customize-control-theme_options-layout_options_blog #bizbell-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #bizbell-img-container li').each(function(){
            $(this).find('img').removeClass ('bizbell-radio-img-selected') ;
        });
        $(this).addClass ('bizbell-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #bizbell-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #bizbell-img-container li').each(function(){
            $(this).find('img').removeClass ('bizbell-radio-img-selected') ;
        });
        $(this).addClass ('bizbell-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #bizbell-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #bizbell-img-container li').each(function(){
            $(this).find('img').removeClass ('bizbell-radio-img-selected') ;
        });
        $(this).addClass ('bizbell-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #bizbell-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #bizbell-img-container li').each(function(){
            $(this).find('img').removeClass ('bizbell-radio-img-selected') ;
        });
        $(this).addClass ('bizbell-radio-img-selected') ;
    });    

    function bizbell_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            bizbell_customize_multi_write( $control );
    }

    function bizbell_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        bizbell_customize_multi_write( $control );
    }

    function bizbell_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function bizbell_customize_multi_write( $element) {

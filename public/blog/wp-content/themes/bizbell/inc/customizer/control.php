...
class BizBell_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="bizbell-chosen-select" <?php $this->link(); ?>>
                    <?php
...
Class BizBell_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class BizBell_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class BizBell_Note_Control extends WP_Customize_Control {

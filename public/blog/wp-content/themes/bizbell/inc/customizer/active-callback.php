...
function bizbell_testimonial_active( $control ) {
...
function bizbell_team_active( $control ) {
...
function bizbell_services_active( $control ) {
...
function bizbell_information_active( $control ) {
...
function bizbell_slider_active( $control ) {
...
function bizbell_cta_active( $control ) {
...
function bizbell_blog_active( $control ) {
 ...
 */
function bizbell_contact_info_ac( $control ) {
...
function bizbell_social_links_active( $control ) {

<div>
    ...
    <x-jet-form-section submit="createApiToken">
        ...
        <x-slot name="actions">
            <x-jet-action-message class="mr-3 text-green-500" on="created">
                {{ __('Created.') }}
    ...
    @if ($this->user->company->users->pluck('tokens')->isNotEmpty())
            ...
            <x-jet-action-section>
                ...
                <x-slot name="content">
                    <div class="space-y-6">
                        ...
                        {{-- $this->user->tokens->sortBy('name') --}}
                        @foreach ($this->user->company->users->pluck('tokens')->flatten()->sortBy('name') as $token)

<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            ...
            <div x-data="{backgroundName: null, backgroundPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <input type="file" class="hidden"
                            ...
                            x-ref="background"
                            x-on:change="
                                    photoName = $refs.background.files[0].name;
                                    const reader = new FileReader();
                                    reader.onload = (e) => {
                ...
                <!-- Current Profile Photo -->
                <div class="mt-2" x-show="! backgroundPreview">
                    <img src="{{ $this->user->background_photo_path }}" alt="{{ $this->user->name }}" class="rounded-full h-20 w-20 object-cover">
                </div>

                <!-- New Profile Photo Preview -->
                <div class="mt-2" x-show="backgroundPreview">
                    <span class="block rounded-full w-20 h-20"
                          x-bind:style="'background-size: cover; background-repeat: no-repeat; background-position: center center; background-image: url(\'' + backgroundPreview + '\');'">
                    </span>
                </div>

                <x-jet-secondary-button class="mt-2 mr-2" type="button" x-on:click.prevent="$refs.background.click()">
        ...
        <!-- Work Anniversary -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="anniversary" value="{{ __('Work Anniversary') }}"/>
